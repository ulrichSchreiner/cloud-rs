...
pub struct V1ContainerUsageRequest {
...
impl V1ContainerUsageRequest {
    pub fn new(annotations: Vec<String>, from: String) -> V1ContainerUsageRequest {
        V1ContainerUsageRequest {
            annotations,
            clusterid: None,
            from,
            namespace: None,
