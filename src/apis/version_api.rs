...
pub async fn info(configuration: &configuration::Configuration, ) -> Result<crate::models::RestVersion, Error<InfoError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/v1/version", configuration.base_path);
